...
CREATE TABLE book
 ...
 insert into book values ('꽃을 보듯 너를 본다',9791157280292,'나태주');
...
insert into member values('1','1','조세호','931212-2569811','광주광역시 광산구 풍영로 300','010-5555-5555');
insert into member values('jandongun','0000','장돈건','941212-2570812','광주광역시 서구 하남대로 710번길 19','010-7777-7777');
